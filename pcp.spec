...
# testsuite, pre-release issues patch
Patch1: bz1198981.patch
# postfix pmda tries to setgid to postfix user and fails
Patch2: bz1213724.patch
# postfix pmda does not report mails submitted using mail program
Patch3: bz1213764.patch
# consistent naming for tools related to LVM cache
Patch4: bz1218007.patch
